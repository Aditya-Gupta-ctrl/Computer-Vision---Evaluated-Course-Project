...
**[Computer Vision Evaluated Course Project](https://www.kaggle.com/datasets/adityagupta69/computer-vision-evaluated-course-project)**
 
Download the dataset and place the files in `../input/` before running the notebook.
